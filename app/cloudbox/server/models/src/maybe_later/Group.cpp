...
//------------------------------------------------------------------------------
Group::Group(MongoConnection* pConnection)
: GenericModel("groups", pConnection)
{
}
...
//------------------------------------------------------------------------------
GenericModel* Group::create(MongoConnection* pConnection) const
{
   return new Group(pConnection);
}
