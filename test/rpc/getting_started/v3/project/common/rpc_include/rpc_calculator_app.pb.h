...
#ifndef PROTOBUF_rpc_5fcalculator_5fapp_2eproto__INCLUDED
#define PROTOBUF_rpc_5fcalculator_5fapp_2eproto__INCLUDED
...
class Parameters : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_rpc_5fcalculator_5fapp_2eproto();
  friend void protobuf_AssignDesc_rpc_5fcalculator_5fapp_2eproto();
  friend void protobuf_ShutdownFile_rpc_5fcalculator_5fapp_2eproto();
...
class UserAttributes : public ::google::protobuf::Message {
 public:
  ...
  inline const ::rpc_calculator_app::UserName& name() const;
  inline ::rpc_calculator_app::UserName* mutable_name();
  inline ::rpc_calculator_app::UserName* release_name();
  inline void set_allocated_name(::rpc_calculator_app::UserName* name);
 ...
 private:
  ...
  ::rpc_calculator_app::UserName* name_;
...
class UserAttributesList : public ::google::protobuf::Message {
 public:
  ...
  inline const ::rpc_calculator_app::UserAttributes& users(int index) const;
  inline ::rpc_calculator_app::UserAttributes* mutable_users(int index);
  inline ::rpc_calculator_app::UserAttributes* add_users();
  inline const ::google::protobuf::RepeatedPtrField< ::rpc_calculator_app::UserAttributes >&
      users() const;
  inline ::google::protobuf::RepeatedPtrField< ::rpc_calculator_app::UserAttributes >*
      mutable_users();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::rpc_calculator_app::UserAttributes > users_;
...
inline const ::rpc_calculator_app::UserName& UserAttributes::name() const {
  return name_ != NULL ? *name_ : *default_instance_->name_;
}
inline ::rpc_calculator_app::UserName* UserAttributes::mutable_name() {
  set_has_name();
  if (name_ == NULL) name_ = new ::rpc_calculator_app::UserName;
  return name_;
}
inline ::rpc_calculator_app::UserName* UserAttributes::release_name() {
  clear_has_name();
  ::rpc_calculator_app::UserName* temp = name_;
  name_ = NULL;
  return temp;
}
inline void UserAttributes::set_allocated_name(::rpc_calculator_app::UserName* name) {
  delete name_;
  name_ = name;
  if (name) {
    set_has_name();
...
inline const ::rpc_calculator_app::UserAttributes& UserAttributesList::users(int index) const {
  return users_.Get(index);
}
inline ::rpc_calculator_app::UserAttributes* UserAttributesList::mutable_users(int index) {
  return users_.Mutable(index);
}
inline ::rpc_calculator_app::UserAttributes* UserAttributesList::add_users() {
  return users_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::rpc_calculator_app::UserAttributes >&
...
#endif  // PROTOBUF_rpc_5fcalculator_5fapp_2eproto__INCLUDED
