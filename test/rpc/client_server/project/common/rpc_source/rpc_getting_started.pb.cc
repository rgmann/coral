...
void protobuf_AssignDesc_rpc_5fgetting_5fstarted_2eproto() {
  protobuf_AddDesc_rpc_5fgetting_5fstarted_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "rpc_getting_started.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_rpc_5fgetting_5fstarted_2eproto);
}
...
void protobuf_AddDesc_rpc_5fgetting_5fstarted_2eproto() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "rpc_getting_started.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_rpc_5fgetting_5fstarted_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_rpc_5fgetting_5fstarted_2eproto {
  StaticDescriptorInitializer_rpc_5fgetting_5fstarted_2eproto() {
    protobuf_AddDesc_rpc_5fgetting_5fstarted_2eproto();
  }
} static_descriptor_initializer_rpc_5fgetting_5fstarted_2eproto_;
...
const Parameters& Parameters::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_rpc_5fgetting_5fstarted_2eproto();
...
void UserAttributes::InitAsDefaultInstance() {
  name_ = const_cast< ::rpc_getting_started::UserName*>(&::rpc_getting_started::UserName::default_instance());
}
...
void UserAttributes::MergeFrom(const UserAttributes& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_name()) {
      mutable_name()->::rpc_getting_started::UserName::MergeFrom(from.name());
    }
    if (from.has_age()) {
      set_age(from.age());
    }
