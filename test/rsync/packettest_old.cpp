...
bool testRsyncPacket()
{
   ...
   if (l_pPktHdr->marker != RsyncPacket::RsyncPacketMarker)
   {
      printf("testRsyncPacket: failure at line #%d\n", __LINE__);
      return false;
   }
...
bool testRsyncSegmentReportPacket()
{
   ...
   l_pSuperPkt = reinterpret_cast<RsyncPacket*>(l_pTxPacket);
...
bool testSegmentReportHeader()
{
   ...
   RsyncSegmentReportHdr      l_RxPacket;
...
//   }
   ...
   l_pPktData = (RsyncSegmentReportHdr::Data*)(l_pPackedPkt +
                                       sizeof(RsyncPacket::Data) +
                                       sizeof(RsyncSegmentReportPacket::Data));
